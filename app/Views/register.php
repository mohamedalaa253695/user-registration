                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                          ...
                          <div class="form-gp">
                            ...
                            <input type="tel" id="" name="phone" value="<?= old('phone') ?>" required>
                            <i class="ti-headphone-alt"></i>
                            <div class="text-danger"></div>
                        </div>
                         <div class="form-gp">
                            <label for="exampleInputEmail1">Address</label>
                            <input type="text" id="" name="address" value="<?= old('address') ?>">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" id="exampleInputPassword2" name="password_confirm" value="" required>
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted">Don't have an account? <a href="<?= base_url('login'); ?>">Sign in</a></p>
                        </div>
                    </div>
                </form>
            </div>
